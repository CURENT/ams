...
from ams.pypower.opf_args import opf_args
from ams.pypower.makeBdc import makeBdc
from ams.pypower.makeAvl import makeAvl
from ams.pypower.makeApq import makeApq
from ams.pypower.makeAang import makeAang
from ams.pypower.makeAy import makeAy
from ams.pypower.opf_model import opf_model
from ams.pypower.run_userfcn import run_userfcn

from ams.pypower.idx_cost import MODEL, NCOST, PW_LINEAR, COST, POLYNOMIAL
from ams.pypower.idx_bus import BUS_TYPE, REF, VA, VM, PD, GS, VMAX, VMIN
from ams.pypower.idx_gen import GEN_BUS, VG, PG, QG, PMAX, PMIN, QMAX, QMIN
from ams.pypower.idx_brch import RATE_A
        ...
        if nusr or nw:
            ...
            if nw and (ppc['N'].shape[1] >= 2*nb + 2*ng):
                ...
                if ppc['N'][:, acc].nnz > 0:
                    ...
                    _, ii = unique(ii, return_index=True)
